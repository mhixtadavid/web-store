		...
		<div class="container">
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="index.html">Our Store <span>Shop anywhere</span></a></h1>
				</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				<h2><a href="index.html">Our Store <span>shop anywhere</span></a></h2>
			</div>
			<div class="copy-right animated wow slideInUp" data-wow-delay=".5s">
				<p>&copy 2023 Our Store. All rights reserved | Design by <br> <a href="#">Our Enterprise</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
